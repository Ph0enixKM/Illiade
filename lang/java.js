...
const JAVA_LANGUAGE = {
    ...
    keywords: [
      'abstract', 'assert', 'boolean', 'break', 'byte', 'case', 'class', 'const', 'continue',
      ...
      'new', 'non-seald', 'package', 'private', 'protected', 'public', 'return', 'short', 'static',
    ...
    tokenizer: {
      root: [
        ...
        [/\b(class|enum|namespace|interface)(\s+)([A-Za-z0-9_$]+)/, ['keyword', 'default', 'special']],
        [/this/, 'special'],
