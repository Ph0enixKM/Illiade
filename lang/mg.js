...
const MG_LANGUAGE = {
    ...
    tokenizer: {
      root: [
        ...
        // Keywords
        [/\b(break|loop|setup|with|class|continue|const|constructor|debugger|default|delete|do|else|export|extends|finally|for|from|function|get|if|import|in|instanceof|let|new|return|set|switch|symbol|throw|try|typeof|var|while|with|yield|async|await|of)\b/, "keyword"],
        [/(\*|&)(?=[^&])/, 'keyword'],
