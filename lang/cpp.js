...
const CPP_LANGUAGE = {
    ...
    tokenizer: {
      root: [
        ...
        // Keywords
        [/\b(friend|virtual|operator|long|template|typename|using|typedef|namespace|abstract|continue|for|new|switch|goto|do|if|private|this|break|protected|throw|else|public|enum|return|catch|try|static|class|finally|virtual|const|while|loop|loopWith|loopFromTo|export|case)\b/, "keyword"],
        [/(\*|&)(?=[^&])/, 'keyword'],
