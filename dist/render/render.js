...
amdRequire(['vs/editor/editor.main'], () => {
    ...
    monaco.editor.defineTheme('blaze', {
        ...
        rules: [{ token: 'comment.cpp', foreground: '555555', fontStyle: 'italic' }, { token: 'keyword', foreground: 'cc4400' }, { token: 'number', foreground: 'ff8800' }, { token: 'string', foreground: '44aa00' }, { background: '000000' }]
    });
